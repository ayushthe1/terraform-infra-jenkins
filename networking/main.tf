...
# allows communication between resources inside the Virtual Private Cloud (VPC) and the internet. It serves as a gateway through which traffic can flow in and out of your VPC
...
// attaching all the private subnets with the private route table
